...
# Goal: To demonstrate unsloth's MoE optimizations on AMD GPUs (ROCm) for `imdatta0/tiny_qwen3_moe_2.8B_0.7B` by finetuning on by OpenR1's Math dataset.

# In[4]:


model_name = "imdatta0/tiny_qwen3_moe_2.8B_0.7B" # This is dummy model of qwen3moe architecture created to fit in smaller GPU memory
