...
if False: # Pushing to HF Hub
    model.push_to_hub_merged("HF_USERNAME/ernie_finetune_16bit", tokenizer, save_method = "merged_16bit", token = "")

# Merge to 4bit
if False:
    model.save_pretrained_merged("ernie_finetune_4bit", tokenizer, save_method = "merged_4bit",)
if False: # Pushing to HF Hub
    model.push_to_hub_merged("HF_USERNAME/ernie_finetune_4bit", tokenizer, save_method = "merged_4bit", token = "")
...
if False:
    ...
    tokenizer.save_pretrained("ernie_lora")
if False: # Pushing to HF Hub
    model.push_to_hub("HF_USERNAME/ernie_lora", token = "")
    tokenizer.push_to_hub("HF_USERNAME/ernie_lora", token = "")
...
if False:
    model.push_to_hub_gguf("HF_USERNAME/ernie_finetune", tokenizer, token = "")

# Save to 16bit GGUF
if False:
    model.save_pretrained_gguf("ernie_finetune", tokenizer, quantization_method = "f16")
if False: # Pushing to HF Hub
    model.push_to_hub_gguf("HF_USERNAME/ernie_finetune", tokenizer, quantization_method = "f16", token = "")

# Save to q4_k_m GGUF
if False:
    model.save_pretrained_gguf("ernie_finetune", tokenizer, quantization_method = "q4_k_m")
if False: # Pushing to HF Hub
    model.push_to_hub_gguf("HF_USERNAME/ernie_finetune", tokenizer, quantization_method = "q4_k_m", token = "")
