...
# <a href="https://github.com/unslothai/notebooks/blob/main/nb/AMD-gpt-oss-(20B)_MI300X-GRPO.ipynb" target="_parent">Open on GitHub</a>
...
# 
# **NOTE** An AMD MI300X GPU should complete one generation quickly.
