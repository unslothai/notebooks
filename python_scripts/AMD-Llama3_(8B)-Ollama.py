...
# 
# For example below in our [Titanic CSV finetuning notebook](https://amd-ai-academy.com/github/unslothai/notebooks/blob/main/nb/AMD-Llama3_(8B)-Ollama.ipynb), we merged multiple columns in 1 prompt:
# 
