...
# 
# For example below in our [Titanic CSV finetuning notebook](https://notebooks.amd.com/github/unslothai/notebooks/blob/main/nb/AMD-Llama3_(8B)-Ollama.ipynb), we merged multiple columns in 1 prompt:
# 
