...
# If you want to finetune Llama-3 2x faster and use 70% less VRAM, go to our [finetuning notebook](https://notebooks.amd.com/github/unslothai/notebooks/blob/main/nb/AMD-Llama3_(8B)-Alpaca.ipynb)!
