...
if False: model.push_to_hub_merged("HF_USERNAME/advanced_finetune_16bit", tokenizer, save_method = "merged_16bit", token = "")

# Merge to 4bit
if False: model.save_pretrained_merged("advanced_finetune_4bit", tokenizer, save_method = "merged_4bit",)
if False: model.push_to_hub_merged("HF_USERNAME/advanced_finetune_4bit", tokenizer, save_method = "merged_4bit", token = "")
...
if False:
    model.push_to_hub("HF_USERNAME/advanced_lora", token = "")
    tokenizer.push_to_hub("HF_USERNAME/advanced_lora", token = "")
...
if False: model.push_to_hub_gguf("HF_USERNAME/advanced_finetune", tokenizer, token = "")

# Save to 16bit GGUF
if False: model.save_pretrained_gguf("advanced_finetune", tokenizer, quantization_method = "f16")
if False: model.push_to_hub_gguf("HF_USERNAME/advanced_finetune", tokenizer, quantization_method = "f16", token = "")

# Save to q4_k_m GGUF
if False: model.save_pretrained_gguf("advanced_finetune", tokenizer, quantization_method = "q4_k_m")
if False: model.push_to_hub_gguf("HF_USERNAME/advanced_finetune", tokenizer, quantization_method = "q4_k_m", token = "")
