...
# 
# 
# get_ipython().system('uv pip install --system -qqq git+https://github.com/huggingface/transformers')
# get_ipython().system('uv pip install --system -qqq --upgrade --no-deps "trl==0.22.2"')
# 
# 
# # ### Unsloth

# We're about to demonstrate the power of the new OpenAI GPT-OSS 20B model through an inference example. For our `bnb-4bit` version, use this [notebook](https://amd-ai-academy.com/github/unslothai/notebooks/blob/main/nb/AMD-GPT_OSS_BNB_(20B)-Inference.ipynb) instead.
# 
