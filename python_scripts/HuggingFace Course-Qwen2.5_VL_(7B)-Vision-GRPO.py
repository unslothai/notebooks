...
# </div>
# 
# In this [Hugging Face](https://huggingface.co/learn/nlp-course/en/chapter12/6?fw=pt) and Unsloth notebook, you will learn to transform Qwen2.5 VL (7B) Vision GRPO into a Reasoning model using GRPO.
# 
...
# get_ipython().system('pip install --no-deps --force-reinstall --no-cache-dir git+https://github.com/unslothai/unsloth.git git+https://github.com/unslothai/unsloth_zoo.git')
# 
# 
# # ### Unsloth
