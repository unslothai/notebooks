...
# 
# If you want to use the `llama-3` template for ShareGPT datasets, try our conversational [notebook](https://notebooks.amd.com/github/unslothai/notebooks/blob/main/nb/AMD-Llama3_(8B)-Conversational.ipynb)
# 
