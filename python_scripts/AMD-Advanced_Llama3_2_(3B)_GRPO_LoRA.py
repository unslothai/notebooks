...
# <a href="https://notebooks.amd.com/github/unslothai/notebooks/blob/main/nb/AMD-Advanced_Llama3_2_(3B)_GRPO_LoRA.ipynb" target="_parent">Open In AMD Dev Cloud</a>
...
# Load up `Llama 3.2 3B Instruct`, and set parameters. To finetune a base model from scratch, check out our `Qwen 3 4B Base GRPO` notebook [here](https://notebooks.amd.com/github/unslothai/notebooks/blob/main/nb/AMD-Qwen3_(4B)-GRPO.ipynb)
