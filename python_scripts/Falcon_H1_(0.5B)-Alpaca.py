...
if False: model.push_to_hub_merged("HF_USERNAME/falcon_h1_finetune_16bit", tokenizer, save_method = "merged_16bit", token = "")

# Merge to 4bit
if False: model.save_pretrained_merged("falcon_h1_finetune_4bit", tokenizer, save_method = "merged_4bit",)
if False: model.push_to_hub_merged("HF_USERNAME/falcon_h1_finetune_4bit", tokenizer, save_method = "merged_4bit", token = "")
...
if False:
    ...
    tokenizer.save_pretrained("falcon_h1_lora")
if False:
    model.push_to_hub("HF_USERNAME/falcon_h1_lora", token = "")
    tokenizer.push_to_hub("HF_USERNAME/falcon_h1_lora", token = "")
...
if False: model.push_to_hub_gguf("HF_USERNAME/falcon_h1_finetune", tokenizer, token = "")

# Save to 16bit GGUF
if False: model.save_pretrained_gguf("falcon_h1_finetune", tokenizer, quantization_method = "f16")
if False: model.push_to_hub_gguf("HF_USERNAME/falcon_h1_finetune", tokenizer, quantization_method = "f16", token = "")

# Save to q4_k_m GGUF
if False: model.save_pretrained_gguf("falcon_h1_finetune", tokenizer, quantization_method = "q4_k_m")
if False: model.push_to_hub_gguf("HF_USERNAME/falcon_h1_finetune", tokenizer, quantization_method = "q4_k_m", token = "")
