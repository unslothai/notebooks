...
def _(mo):
    mo.md(r"""
    To run this, press the **Run** button beside each cell on a molab A100 instance!
...
def _():
    ...
    model, tokenizer = FastModel.from_pretrained(
        model_name="unsloth/gemma-4-26B-A4B-it",  # YOUR MODEL YOU USED FOR TRAINING
...
def _(do_gemma_4_inference):
    ...
    do_gemma_4_inference(_messages, max_new_tokens=256)
    return
...
def _(do_gemma_4_inference):
    ...
    do_gemma_4_inference(_messages)
    return
...
def _(tokenizer):
    ...
    tokenizer_1 = get_chat_template(tokenizer, chat_template="gemma-4-thinking")
...
def _(get_chat_template, model_1, tokenizer_1):
    tokenizer_2 = get_chat_template(tokenizer_1, chat_template="gemma-4-thinking")
    _messages = [
        {
            "role": "user",
            "content": [
