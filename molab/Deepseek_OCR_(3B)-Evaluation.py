...
def _():
    ...
    return AutoModel, FastVisionModel, model, os, tokenizer, torch
...
def _(os):
    ...
    def evaluate_model(
        ...
        for idx in iterator:
            ...
            try:
                ...
                continue  # make sure we don't try to sample more than we have
            finally:
    ...
    def print_evaluation_summary(results: Dict, title: str = "Evaluation Results"):
        ...
        print("\n" + "=" * 60)
        print(f"{title}")
        print("=" * 60)  # Run the actual inference
        ...
        for i in range(min(3, len(sorted_indices))):  # Calculate CER
...
def _(
    ...
    return baseline_results, eval_dataset
...
def _(load_dataset):
    ...
    return convert_to_conversation, dataset
...
def _(Dict, torch):
    ...
    class DeepSeekOCRDataCollator:
        ...
        def calculate_image_token_count(
            ...
            if self.crop_mode:  # Get BOS token ID from tokenizer
                ...
                if width_crop_num > 1 or height_crop_num > 1:
                    img_tokens = img_tokens + (num_queries * width_crop_num + 1) * (
        ...
        def process_single_sample(self, messages: List[Dict]) -> Dict[str, Any]:
            ...
            accurately calculating the prompt/response split point.  # Process global view with padding
            """
            images = []
            ...
            image_idx = 0
            tokenized_str.append(self.bos_id)  # Calculate image tokens
            ...
            for message in messages:
                ...
                for i, text_sep in enumerate(text_splits):  # crop_mode = False
...
def _(
    ...
    data_collator = DeepSeekOCRDataCollator(  # Must use!
        tokenizer=tokenizer,
        model=model_1,
        image_size=640,
        base_size=1024,
...
@app.cell
def _(baseline_results, finetuned_results):
    print("\n" + "=" * 60)
