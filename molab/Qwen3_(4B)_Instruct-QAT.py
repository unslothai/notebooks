...
def _(model_1):
    ...
    quantize_(model_1, QATConfig(step="convert"))
    return
...
@app.cell
def _(model_1, tokenizer_1):
    model_1.save_pretrained_torchao("model", tokenizer_1)
    return
...
def _(model_1, tokenizer_1):
    ...
    if False:
        from torchao.quantization import Int4WeightOnlyConfig as _Int4WeightOnlyConfig

        model_1.save_pretrained_torchao(
            "model", tokenizer_1, torchao_config=_Int4WeightOnlyConfig()
        )
    if False:
        from torchao.quantization import Int4WeightOnlyConfig as _Int4WeightOnlyConfig
        ...
        model_1.save_pretrained_torchao(
            "HF_USERNAME/model",
            tokenizer_1,
            torchao_config=_Int4WeightOnlyConfig(),
            push_to_hub=True,
    ...
    if False:
        ...
        model_1.save_pretrained_torchao(
            "model",
            tokenizer_1,
            torchao_config=_Int8DynamicActivationInt8WeightConfig(),
        )
    if False:
        from torchao.quantization import (
            Int8DynamicActivationInt8WeightConfig as _Int8DynamicActivationInt8WeightConfig,
