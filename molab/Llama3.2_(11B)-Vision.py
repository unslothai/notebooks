...
def _(FastVisionModel, dataset, model_1, tokenizer):
    ...
    instruction_1 = "You are an expert radiographer. Describe accurately what you see in this image."
    messages = [
        {
            "role": "user",
...
def _(FastVisionModel, TextStreamer, dataset, model_1, tokenizer):
    ...
    instruction_2 = "You are an expert radiographer. Describe accurately what you see in this image."
    messages_1 = [
        {
            "role": "user",
...
def _(TextStreamer, dataset, model_1, tokenizer):
    if False:
        ...
        _model, _tokenizer = _FastVisionModel.from_pretrained(
            model_name="llama_lora", load_in_4bit=True  # YOUR MODEL YOU USED FOR TRAINING
        )
        _FastVisionModel.for_inference(_model)
    image_2 = dataset[0]["image"]
    instruction_3 = "You are an expert radiographer. Describe accurately what you see in this image."
    messages_2 = [
        {
            "role": "user",
