...
def _():
    ...
    dataset = load_dataset(
        "LLM360/TxT360-3efforts", name="agent", split="medium", streaming=True
    )
...
def _():
    ...
    return (prepare_messages_and_tools,)
...
@app.cell
def _(dataset, prepare_messages_and_tools, tokenizer):
...
def _(tokenizer, trainer_1):
    tokenizer.decode(trainer_1.train_dataset[-1]["input_ids"])
    return
...
@app.cell
def _(model_1, prepare_messages_and_tools, tokenizer, train_dataset):
