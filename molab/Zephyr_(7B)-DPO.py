...
def _():
    ...
    def mix_datasets(
        ...
        if len(raw_train_datasets) > 0:
            ...
            if shuffle:
                raw_datasets["train"] = concatenate_datasets(train_subsets).shuffle(
                    seed=42
                )
            else:
    ...
    return apply_chat_template, get_datasets
...
@app.cell
def _(apply_chat_template, get_datasets, tokenizer):
...
@app.cell
def _(model_1, raw_datasets, tokenizer):
