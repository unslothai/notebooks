...
def _():
    ...
    model, tokenizer = FastModel.from_pretrained(
        model_name="unsloth/gemma-3-27b-it",  # YOUR MODEL YOU USED FOR TRAINING
...
def _(model_1, tokenizer_2):
    ...
    tokenizer_2.save_pretrained("gemma_3_lora")
    return
...
def _(model_1, tokenizer_2):
    if False:  # Change to True to save finetune!
        model_1.save_pretrained_merged("gemma-3-finetune", tokenizer_2)
    return
...
def _(model_1, tokenizer_2):
    if False:  # Change to True to upload finetune
        model_1.push_to_hub_merged(
            "HF_ACCOUNT/gemma-3-finetune", tokenizer_2, token="YOUR_HF_TOKEN"
        )
    return
...
def _(model_1, tokenizer_2):
    if False:  # Change to True to save to GGUF
        model_1.save_pretrained_gguf(
            "gemma_3_finetune", tokenizer_2, quantization_method="Q8_0"
